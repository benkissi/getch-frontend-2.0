...
var getCampaigns = function getCampaigns(fbId, token) {
  var url, headers, params, res;
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.async(function getCampaigns$(_context8) {
    while (1) {
      switch (_context8.prev = _context8.next) {
        case 0:
          url = _endpoints__WEBPACK_IMPORTED_MODULE_3__["default"].GET_CAMPAIGNS(fbId);
          headers = {
            'Authorization': token
          };
          params = {
...
//# sourceMappingURL=performance.js.13e1bb07105ac255fa1a.hot-update.js.map